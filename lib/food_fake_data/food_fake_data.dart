...
List<Food> foods = [
  Pizza(
    ...
    image: "assets/images/pizza/margherita 2.jpg",
    isPopular: true,
    isWhitePizza: false,
    ingredients: [
  ...
  Pizza(
    ...
    category: FoodCategory.vegetarian,
    image: "assets/images/pizza/Marinara2.jpg",
    isPopular: true,
    isWhitePizza: false,
    ingredients: [
      Ingredient(name: "Pomodoro", icon: PngIcons.withName(PngIcons.tomato)),
  ...
  Pizza(
    ...
    image: "assets/images/pizza/Diavola2.jpg",
    isPopular: true,
    isWhitePizza: false,
    ingredients: [
      Ingredient(
  ...
  Pizza(
    ...
    category: FoodCategory.vegetarian,
    image: "assets/images/pizza/Pomodoro2.jpg",
    isPopular: true,
    isWhitePizza: true,
    ingredients: [
      Ingredient(
  ...
  Pizza(
    ...
    category: FoodCategory.normal,
    image: "assets/images/pizza/Francescana2.jpg",
    isPopular: true,
    isWhitePizza: false,
    ingredients: [
      Ingredient(
  ...
  Pizza(
    ...
    category: FoodCategory.normal,
    image: "assets/images/pizza/Porkys2.jpg",
    isPopular: true,
    isWhitePizza: true,
    ingredients: [
      Ingredient(
  ...
  Pizza(
    ...
    category: FoodCategory.vegetarian,
    image: "assets/images/pizza/Morbidosa2.jpg",
    isPopular: true,
    isWhitePizza: true,
    ingredients: [
      Ingredient(
  ...
  Burger(
    ...
    image: "assets/images/burger/Classic2.jpg",
    category: FoodCategory.normal,
    ingredients: [
      Ingredient(
        name: "Pomodoro",
  ...
  Burger(
    ...
    image: "assets/images/burger/Chicken2.jpg",
    category: FoodCategory.normal,
    ingredients: [
      Ingredient(
        name: "Insalata",
  ...
  Burger(
    ...
    image: "assets/images/burger/Fish Burger2.jpg",
    category: FoodCategory.normal,
    ingredients: [
      Ingredient(
        name: "Formaggio",
  ...
  Burger(
    ...
    image: "assets/images/burger/Vegans Burger2.jpg",
  ...
  Burger(
    ...
    image: "assets/images/burger/Vegetarian2.jpg",
    category: FoodCategory.vegetarian,
    ingredients: [
      Ingredient(
        name: "Insalata",
  ...
  Fries(
    ...
    image: "assets/images/fries/Mozzarelline2.jpg",
    category: FoodCategory.vegetarian,
    ingredients: [
      Ingredient(
        name: "Mozzarella",
  ...
  Fries(
    ...
    image: "assets/images/fries/Nuggets2.jpg",
    category: FoodCategory.normal,
    ingredients: [
      Ingredient(
        name: "Pollo",
  ...
  Fries(
    ...
    image: "assets/images/fries/Anelli2.jpg",
    category: FoodCategory.normal,
    ingredients: [
      Ingredient(
        name: "Cipolla",
  ...
  Fries(
    ...
    image: "assets/images/fries/Olive all'ascolana2.jpg",
    category: FoodCategory.normal,
    ingredients: [
      Ingredient(
        name: "Olive",
  ...
  Salad(
    ...
    image: "assets/images/fries/Classica2.jpg",
  ...
  Salad(
    ...
    image: "assets/images/salad/Greca2.jpg",
    category: FoodCategory.vegetarian,
    ingredients: [
      Ingredient(
        name: "Insalata",
  ...
  Salad(
    ...
    image: "assets/images/salad/Chicken Salad2.jpg",
    category: FoodCategory.normal,
    ingredients: [
      Ingredient(
        name: "Insalata",
